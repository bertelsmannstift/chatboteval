...
Web-based annotation interface where domain experts label RAG chatbot query-response pairs across multiple evaluation dimensions. Powered by Argilla.
...
**Annotation schema:** _(TBD — pending schema design decision)_

**Output:** _(TBD — pending schema design decision)_
