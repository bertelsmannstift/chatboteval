...
- [0005: Annotation Export Schema](0005-annotation-export-schema.md) — Accepted: flat CSV, one row per annotator response
...
- [0007: Annotation UI Presentation](0007-annotation-presentation.md) — Accepted: joint labelling and visibility contract; full question wording in [Annotation Interface](../design/annotation-interface.md)
