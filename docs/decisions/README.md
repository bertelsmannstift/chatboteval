...
- [0010: Annotation Entrypoints](0010-annotation-entrypoints.md) — Under Discussion: CLI scope for annotation commands
...
- [0014: IAA Metric](0014-annotation-iaa-metric.md) — Draft: Krippendorff's Alpha as primary IAA metric
