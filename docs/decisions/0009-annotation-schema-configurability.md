...
>
>**Argilla admin UI schema editor:** Does not exist in Argilla v2. Schemas must be defined via SDK. Not a viable path without building a custom frontend (out of scope — see [ADR-0001](0001-argilla-annotation-platform.md)).
>
